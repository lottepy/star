...
def allocationDownloader(start_date, end_date, field, folder='raw'):
    ...
    secid_list = pd.read_csv(os.path.join(addpath.data_path, 'pool', '12M', '2020-12-31.csv'))['ms_secid'].tolist()
    ...
    save_path = os.path.join(addpath.data_path, 'categorization', field, folder)
...
if __name__ == '__main__':
    allocationDownloader(start_date='2013-12-31', end_date='2020-12-31', field='GlobalStockSectorBreakdown')
    allocationDownloader(start_date='2013-12-31', end_date='2020-12-31', field='AssetAllocation')
    allocationDownloader(start_date='2013-12-31', end_date='2020-12-31', field='StyleBoxBreakdown')
    allocationDownloader(start_date='2013-12-31', end_date='2020-12-31', field='MarketCapitalBreakdown')
    allocationDownloader(start_date='2013-12-31', end_date='2020-12-31', field='GlobalBondSectorBreakdown')
    allocationDownloader(start_date='2013-12-31', end_date='2020-12-31', field='MaturityRange')
    allocationDownloader(start_date='2013-12-31', end_date='2020-12-31', field='CreditQualityBreakdown')
    allocationDownloader(start_date='2013-12-31', end_date='2020-12-31', field='FixedIncomeStyleBoxNineCellBreakdown')


    # monthly_factor_file_prepare('GlobalStockSectorBreakdown', '2013-12-31', '2020-11-30')
    # monthly_factor_file_prepare('AssetAllocation', '2013-12-31', '2020-11-30')
    # monthly_factor_file_prepare('StyleBoxBreakdown', '2013-12-31', '2020-11-30')
    # monthly_factor_file_prepare('MarketCapitalBreakdown', '2013-12-31', '2020-11-30')
    # monthly_factor_file_prepare('GlobalBondSectorBreakdown', '2013-12-31', '2020-11-30')
    # monthly_factor_file_prepare('MaturityRange', '2013-12-31', '2020-11-30')
    # monthly_factor_file_prepare('CreditQualityBreakdown', '2013-12-31', '2020-11-30')
    # monthly_factor_file_prepare('FixedIncomeStyleBoxNineCellBreakdown', '2013-12-31', '2020-11-30')
