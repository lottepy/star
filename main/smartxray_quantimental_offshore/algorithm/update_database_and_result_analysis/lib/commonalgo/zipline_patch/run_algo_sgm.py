...
from .trading_sgm import TradingEnvironment
...
def _run(handle_data,
    ...
    if bundle is not None:
        ...
        env = TradingEnvironment(
            ...
            bm_symbol=aqm_params.get('bm_symbol')
        )
        first_trading_day =\
    ...
    # CHG [joseph]: blotter can be specified as either ``default`` or ``AQM``
    if blotter=='default':
        try:
        ...
        from zipline.finance.blotter.simulation_blotter import AQMSimulationBlotter
        blotter = AQMSimulationBlotter()
