...
def csvaqm_futures(tframes=None, csvdir=None):
    """
...
def csvdir_bundle(environ,
    ...
    root_symbols['sector'] = 'sector_test'
    root_symbols['exchange'] = 'CSVDIR'
    root_symbols['description'] = 'description_test'
...
def _pricing_iter(csvdir, symbols, metadata, divs_splits, show_progress, calendar=None, start = None):
    with maybe_show_progress(symbols, show_progress,
        ...
        for sid, symbol in enumerate(it):
            ...
            metadata.iloc[sid] = start_date, end_date, ac_date, symbol, symbol
