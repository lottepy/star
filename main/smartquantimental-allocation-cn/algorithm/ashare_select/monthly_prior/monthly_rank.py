...
def ashare_monthly_rank_helper(rebalance_date):
    rank_path = os.path.join(addpath.data_path, "Ashare", "monthly_prior", "monthly_stock_rank")
    ...
    selected_stocks_path = os.path.join(addpath.data_path, "Ashare", "selected_stocks")
