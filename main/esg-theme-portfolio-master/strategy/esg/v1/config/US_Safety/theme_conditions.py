...
def theme_conditions(last_period_factors,symbol_industry, investment_univ,factor_list):
    criteria = {
        factor_list[0]: ['Negative',0.5],
        # factor_list[1]: ['Negative',0.1],
        # factor_list[2]: ['Negative', 0.1],
        factor_list[3]: ['Negative', 0.1],
        factor_list[4]: ['Negative', 0.1],
        factor_list[5]: ['Positive', 0.1],
    ...
    ind_list=list(set(symbol_industry['gicsector'].tolist()))
