...
def theme_backtest(portfolio_name, factor_list):
    ...
    report = result_metrics_calculation(pv.iloc[1:])
...
if __name__ == "__main__":
    ...
    factor_list = ['MARKET_CAP', 'REVOAGROWTH', 'GPOE', 'ROA', 'ACCT_RCV_TO', 'EBITDEVAR']
    # factor_list = ['MARKET_CAP', 'REVOAGROWTH', 'GPOE', 'ROA', 'ACCT_RCV_TO']
    ...
    reference_path = os.path.join(addpath.data_path, 'smart_beta', 'hk_data', 'reference',
