...
def create_backtest_engine_files(stocks, strategy_name, strategy_config_path, result_path, start_dt, end_dt, cash,
    ...
    params['data'] = {
        "STOCKS": {
            "DataCenter": "LocalCSV",
            "DataCenterArgs":{
                "main_dir": os.path.join(addpath.data_path, "smart_rotation", "bundles"),
                "fxrate_dir": os.path.join(addpath.data_path, "smart_rotation", "fxrate"),
                "int_dir": os.path.join(addpath.data_path, "smart_rotation", "interest"),
                "info": os.path.join(addpath.data_path, "smart_rotation", "info", "info.csv")
            },
            "Fields": ["OHLC", "volume"],
            "Frequency": "DAILY"
        }
    ...
    # }
    # if strategy_name != "smart_rotation":
    #     params['ref_data'] = {
    #         "mktcap": {
    #             "DataCenter": "LocalCSV",
    #             "DataCenterArgs": {
    #               "dir": os.path.join(addpath.data_path, "smart_rotation", "mktcap")
    #             },
    #             "Symbol":  stocks,
    #             "StartDate": {
