...
from algorithm.utils.enum_type import EnumBase
...
STRATEGY_CODE = {
	"CN":os.path.join(addpath.data_path, "strategy_temps", "CN", "portfolios"),
    # "CN_BFT_Value":os.path.join(addpath.data_path, "smart_beta", "strategy_temps", "CN_BFT_Value", "portfolios"),
    # "CN_Quality2":os.path.join(addpath.data_path, "smart_beta", "strategy_temps", "CN_Quality2", "portfolios"),
    "HK_HSTECH":os.path.join(addpath.data_path, "strategy_temps", "HK_HSTECH", "portfolios"),
    "US_Profit":os.path.join(addpath.data_path, "strategy_temps", "US_Profit", "portfolios"),
    "US_Safety": os.path.join(addpath.data_path, "strategy_temps", "US_Safety", "portfolios"),
    "US_Tech": os.path.join(addpath.data_path, "strategy_temps", "US_Tech", "portfolios"),
...
# SGM Preference Mapping:
REG_LIST = ["NON", "AUS", "DEU", "HKG", "JPN", "GBR", "CHN"]
SEC_LIST = ["NON", "TEC", "CNS", "UTL", "HEA"]
