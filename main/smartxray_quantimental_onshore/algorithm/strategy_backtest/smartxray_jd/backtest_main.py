...
def xray_backtest(strategy_name, start_str, end_str, cash, commission_rate, sector_preference, invest_length, rat):
    portfolio_path = os.path.join(addpath.data_path, "pool", "JD")
...
if __name__ == "__main__":
    strategy_name = "smartxray_jd"
    cash = 1000000
    start_str = '2015-11-30'
    end_str = '2020-09-30'
    ...
    save_dm_to_local = False
    use_local_dm = True
    xray_backtest(strategy_name, start_str, end_str, cash, commission_rate, sector_preference, invest_length, rat)
