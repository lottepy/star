...
def combine_main(start_str, end_str, cash, commission_rate):
    strategy_name = "fix_weight_combine"
    result_path = join(addpath.result_path, "combine", strategy_name)
    window_size = 52 * 5 * 2
    ...
    # full_etf_name = ['pv_ashare_rf_qtr', 'pv_bond']
    full_etf_name = ['pv_ashare_rf_sw2_qtr_timed', 'pv_bond']
...
if __name__ == "__main__":
    ...
    base_strategy = 1
    combine_main(start_str, end_str, cash, commission_rate)
    te0 = datetime.now()
    print("任务总用时", te0 - ts0)
