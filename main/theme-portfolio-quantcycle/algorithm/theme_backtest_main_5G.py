...
def theme_backtest(portfolio_name,factor1,factor2,factor3,factor4, factor5, factor6):
    ...
    symbol_list_path = os.path.join(symbol_path, "symbol_industry_5G.csv")
...
if __name__ == "__main__":
    ...
    # factor6_list = list(['ROE', 'ROE_SEMI', 'ROE_TTM', \
