...
if __name__ == "__main__":
    portfolio_name = "CN_BFT_Value"
    factor1_list = list(['MARKET_CAP'])

    factor2_list = list(['ETP_TTM'])

    factor3_list = list(['REVOAGROWTH'])

    factor4_list = list(['ROA_SEMI'])

    factor5_list = list(['OPCFOE_SEMI'])

    factor6_list = list(['EBITOAVAR'])
    #
    # 'ROE', 'ROE_SEMI', 'ROE_TTM', 'ROA', 'ROA_SEMI', 'ROA_TTM'
    # 'OPCFOA', 'OPCFOA_SEMI', 'OPCFOA_TTM', 'OPCFOE', 'OPCFOE_SEMI', 'OPCFOE_TTM', \
    # 'REVOA', 'REVOA_SEMI', 'REVOA_TTM', 'REVOE', 'REVOE_SEMI', 'REVOE_TTM', \
    # 'EBITOA', 'EBITOA_SEMI', 'EBITOA_TTM', 'EBITOE', 'EBITOE_SEMI', 'EBITOE_TTM', \
    # 'OPCF_MARGIN', 'NET_MARGIN', 'EBIT_MARGIN', 'OPCF_MARGIN_SEMI', 'NET_MARGIN_SEMI', 'EBIT_MARGIN_SEMI', \
    # 'OPCF_MARGIN_TTM', 'NET_MARGIN_TTM', 'EBIT_MARGIN_TTM', \
    # 'ROAGROWTH', 'REVOAGROWTH', 'OPCFOAGROWTH', 'EBITOAGROWTH', \
    # 'ROEGROWTH', 'REVOEGROWTH', 'OPCFOEGROWTH', 'EBITOEGROWTH', \
    # 'ROAGROWTH_SEMI', 'REVOAGROWTH_SEMI', 'OPCFOAGROWTH_SEMI', 'EBITOAGROWTH_SEMI', \
    # 'ROEGROWTH_SEMI', 'REVOEGROWTH_SEMI', 'OPCFOEGROWTH_SEMI', 'EBITOEGROWTH_SEMI', \
    # 'ROAGROWTH_TTM', 'REVOAGROWTH_TTM', 'OPCFOAGROWTH_TTM', 'EBITOAGROWTH_TTM', \
    # 'ROEGROWTH_TTM', 'REVOEGROWTH_TTM', 'OPCFOEGROWTH_TTM', 'EBITOEGROWTH_TTM', \
    # 'BTM', 'ETP', 'STP', 'ETP_TTM', 'STP_TTM', 'MARKET_CAP'

    # 'LEV', 'ROAVAR', 'ROEVAR', 'REVVAR', 'OPCFOAVAR', 'OPCFOEVAR', 'EBITOAVAR', 'EBITOEVAR', 'ROAVAR_SEMI', \
    # 'ROEVAR_SEMI', 'REVVAR_SEMI', 'OPCFOAVAR_SEMI', 'OPCFOEVAR_SEMI', 'EBITOAVAR_SEMI', 'EBITOEVAR_SEMI', \
    # 'ROAVAR_TTM', 'ROEVAR_TTM', 'REVVAR_TTM', 'OPCFOAVAR_TTM', 'OPCFOEVAR_TTM', 'EBITOAVAR_TTM', 'EBITOEVAR_TTM'
                ...
                for factor4 in factor4_list:
                    for factor5 in factor5_list:
                        for factor6 in factor6_list:
                            ...
                            reference_path = os.path.join(addpath.data_path, 'cn_data', 'reference',
