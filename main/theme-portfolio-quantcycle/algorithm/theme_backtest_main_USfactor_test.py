...
if __name__ == "__main__":
    ...
    factor1_list = list(['GPOAVAR_TTM','GPOEVAR_TTM', \
                         'LONGTERM_DEBTRATIO', 'LONGTERM_LIABRATIO'])  #'ROE','ROE_SEMI','ROE_TTM'


#'LEV','Z_SCORE','ROAVAR','ROEVAR'
    # 'OPCFOEVAR', 'GPOAVAR', 'GPOEVAR', 'EBITDAVAR', 'EBITDEVAR', \
    # 'ROAVAR_SEMI', 'ROEVAR_SEMI', 'OPCFOAVAR_SEMI',
    # 'GPOAVAR_SEMI', 'GPOEVAR_SEMI', \
    # 'ROAVAR_TTM', 'ROEVAR_TTM', 'OPCFOAVAR_TTM',



 #    'ROE', 'ROE_SEMI', 'ROE_TTM', \
 #    'ROA', 'ROA_SEMI', 'ROA_TTM', \
 ...
 # \
 #    'BTM',
 #    'ETP_SEMI', 'ETP_TTM', 'STP', 'STP_SEMI', 'STP_TTM', \
 # \
 ...
 #    'EBITOAGROWTH', 'EBITOAGROWTH_SEMI', 'EBITOAGROWTH_TTM', 'EBITOEGROWTH', 'EBITOEGROWTH_SEMI', 'EBITOEGROWTH_TTM',
 #    'EBTOAGROWTH','EBTOAGROWTH_SEMI','EBTOAGROWTH_TTM'

    factor2_list = list(['ROA_TTM'])  #'ROA','ROA_SEMI','ROA_TTM'
    factor3_list = list(['ROA_TTM'])
    #'GPOA','GPOE','GPOA_SEMI','GPOE_SEMI','GPOA_TTM','GPOE_TTM'
    factor4_list = list(['OPCFOA_SEMI'])
    #'OPCFOA','OPCFOA_SEMI','OPCFOA_TTM','OPCFOE','OPCFOE_SEMI','OPCFOE_TTM'
    factor5_list = list(['OP_MARGIN'])
    #'GROSS_PROFIT_MARGIN','OPCF_MARGIN','NET_MARGIN','GROSS_PROFIT_MARGIN_SEMI','OPCF_MARGIN_SEMI','NET_MARGIN_SEMI','GROSS_PROFIT_MARGIN_TTM','OPCF_MARGIN_TTM','NET_MARGIN_TTM'
    factor6_list = list(['NIexACConASSET_TTM'])
    #'NIexACConNI','NIexACConNI_SEMI','NIexACConNI_TTM','NIexACConASSET','NIexACConASSET_SEMI','NIexACConASSET_TTM'

    # 'EBITDAOA','EBITDAOE','EBITDAOA_SEMI','EBITDAOE_SEMI','EBITDAOA_TTM','EBITDAOE_TTM'
    # 'EBITOA','EBITOE','EBITOA_SEMI','EBITOE_SEMI','EBITOA_TTM','EBITOE_TTM'
    # 'EBTOA','EBTOE','EBTOA_SEMI','EBTOE_SEMI','EBTOA_TTM','EBTOE_TTM'
    # 'NIexACConNI_TTM', 'NIexACConASSET', 'NIexACConASSET_SEMI','NIexACConASSET_TTM',
