...
if __name__ == "__main__":
    portfolio_name = "HK_HSTECH"
    factor1_list = list(['MARKET_CAP'])
    factor2_list = list(['REVOAGROWTH'])
    factor3_list = list(['GPOE'])

    factor4_list = list(['ROA'])

    factor5_list = list(['ACCT_RCV_TO'])

    factor6_list = list(['EBITDEVAR'])

    # factor6_list = list(['ROAVAR','ROEVAR','OPCFOEVAR','OPCFOAVAR', 'GPOAVAR', 'GPOEVAR','EBITDAVAR', 'EBITDEVAR', \
    #                      'ROAVAR_TTM', 'ROEVAR_TTM', 'OPCFOEVAR_TTM', 'OPCFOAVAR_TTM', 'GPOAVAR_TTM', 'GPOEVAR_TTM', 'EBITDAVAR_TTM', 'EBITDEVAR_TTM'])
    #'Z_SCORE','LONGTERM_DEBTRATIO','SHORTTERM_DEBTRATIO','ST_PORTION_OF_LT'
                         # 'ROAVAR','ROEVAR','OPCFOEVAR','OPCFOAVAR', 'GPOAVAR', 'GPOEVAR','EBITDAVAR', 'EBITDEVAR', \
                         # 'ROAVAR_TTM', 'ROEVAR_TTM', 'OPCFOEVAR_TTM', 'OPCFOAVAR_TTM', 'GPOAVAR_TTM', 'GPOEVAR_TTM', 'EBITDAVAR_TTM', 'EBITDEVAR_TTM'

    # factor6_list = list(['MARKET_CAP','NIexACConNI','NIexACConNI_TTM','NIexACConASSET','NIexACConASSET_TTM','ASSETGROWTH','BVGROWTH',\
    #                      'WORKING_CAPITAL','CURRENT_RATIO','QUICK_RATIO','ACCT_RCV_TO','ACCT_RCV_TO_TTM','ACCT_PAY_TO','ACCT_PAY_TO_TTM',\
    #                      'EBITDAOA','EBITDAOE','EBITOA','EBITOE','EBTDAOA','EBTDAOE','ROE','ROA','GPOA','GPOE','EBITDAOA_TTM','EBITDAOE_TTM',\
    #                      'EBITOA_TTM','EBITOE_TTM','EBTOA_TTM','EBTOE_TTM','ROE_TTM','ROA_TTM','GPOA_TTM','GPOE_TTM','OPCFOA','OPCFOA_TTM','OPCFOE',\
    #                      'OPCFOE_TTM','GROSS_PROFIT_MARGIN','OPCF_MARGIN','NET_MARGIN','GROSS_PROFIT_MARGIN_TTM','OPCF_MARGIN_TTM','NET_MARGIN_TTM',\
    #                      'ROAGROWTH','REVOAGROWTH','OPCFOAGROWTH','GPOAGROWTH','EBITDAOAGROWTH','EBITOAGROWTH','EBTOAGROWTH','ROEGROWTH','REVOEGROWTH',\
    #                      'OPCFOEGROWTH','GPOEGROWTH','EBITDAOEGROWTH','EBITOEGROWTH','EBTOEGROWTH','ROAGROWTH_TTM','REVOAGROWTH_TTM','OPCFOAGROWTH_TTM',\
    #                      'OPCFOAGROWTH_TTM','GPOAGROWTH_TTM','EBITDAOAGROWTH_TTM','EBITOAGROWTH_TTM','EBTOAGROWTH_TTM','ROEGROWTH_TTM','REVOEGROWTH_TTM',\
    #                      'OPCFOEGROWTH_TTM','GPOEGROWTH_TTM','EBITDAOEGROWTH_TTM','EBITOEGROWTH_TTM','EBTOEGROWTH_TTM','BTM','ETP','STP','ETP_TTM','STP_TTM'])
                ...
                for factor4 in factor4_list:
                    for factor5 in factor5_list:
                        for factor6 in factor6_list:
                            ...
                            reference_path = os.path.join(addpath.data_path, 'hk_data', 'reference',
