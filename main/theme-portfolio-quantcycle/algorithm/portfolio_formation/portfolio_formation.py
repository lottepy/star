...
from algorithm.portfolio_formation.investment_universe import investment_universe_Privilege
...
def portfolio_formation(portfolio_name, number_assets, symbol_list,symbol_industry, rebalance_freq, weighting_approach,
						...
						underlying_type, market_cap_threshold, cash,upper_bound, lower_bound,factor1, factor2, factor3,
	...
	rankings = theme_conditions(last_period_factors,symbol_industry, investment_univ,factor1,factor2,factor3,factor4, factor5, factor6)
	...
	portfolio_symbol['LOTPRICE']=lotprice
