...
if __name__ == "__main__":
    ...
    factor1_list = list(['LEV'])
    factor2_list = list(['Z_SCORE'])
    factor3_list = list(['O_SCORE'])

    factor4_list = list(['GPOAVAR_SEMI'])
    #'GPOAVAR','GPOAVAR_SEMI','OPCFOAVAR_TTM','GPOAVAR_TTM','GPOEVAR_TTM'
    #'ROAVAR','ROEVAR','OPCFOAVAR','OPCFOEVAR','GPOAVAR','GPOEVAR','EBITDAVAR','EBITDEVAR','ROAVAR_SEMI','ROEVAR_SEMI',\
    # 'OPCFOAVAR_SEMI','OPCFOEVAR_SEMI','GPOAVAR_SEMI','GPOEVAR_SEMI','ROAVAR_TTM','ROEVAR_TTM','OPCFOAVAR_TTM','OPCFOEVAR_TTM',\
    #'GPOAVAR_TTM','GPOEVAR_TTM'
    factor5_list = list(['LONGTERM_LIABRATIO'])  #'LONGTERM_DEBTRATIO','LONGTERM_LIABRATIO'
    factor6_list = list(['CURRENT_RATIO'])
