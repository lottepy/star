...
if __name__ == "__main__":
    ...
    portfolio_name = "CN_Lowvol"
    factor1_list=list(['RealizedVol_6M'])  #  'RealizedVol_12M',
    factor2_list = list(['RealizedVol_1M'])   #  , 'RealizedVol_3M'
    factor3_list = list(['ivol'])
    factor_df = []
    df = pd.DataFrame()
    ...
    df.to_csv(os.path.join(addpath.result_path, portfolio_name, 'report_best.csv'))
