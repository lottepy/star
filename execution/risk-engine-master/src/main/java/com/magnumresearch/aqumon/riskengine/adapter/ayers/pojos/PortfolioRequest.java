...
public class PortfolioRequest {
    ...
    public PortfolioRequest(String clientAccCode, long msgID) {
        this.type = MessageConstants.MESSAGE_TYPE_PORTFOLIO_REQUEST;
        this.msgnum = String.valueOf(msgID);
        this.clientAccCode = clientAccCode;
    }

    public String toXML() throws JAXBException {
        JAXBContext jc = JAXBContext.newInstance(PortfolioRequest.class);
