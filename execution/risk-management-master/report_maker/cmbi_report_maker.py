...
if __name__ == '__main__':
	risk_metrics_sgm_ytd = pd.read_csv('cmbi/pv_ts_sg_stats_sgm_ytd.csv', index_col=0)
	risk_metrics_sgm_3y = pd.read_csv('cmbi/pv_ts_sg_stats_sgm_3y.csv', index_col=0)
	complete_performance_sgm_ytd = pd.read_csv('cmbi/complete_performance_sgm_ytd.csv', index_col=0, parse_dates=True)
	complete_performance_sgm_3y = pd.read_csv('cmbi/complete_performance_sgm_3y.csv', index_col=0, parse_dates=True)
	holdings_sgm = pd.read_csv('cmbi/holdings_sgm.csv')

	risk_metrics_sx_ytd = pd.read_csv('cmbi/pv_ts_sg_stats_sx_ytd.csv', index_col=0)
	risk_metrics_sx_3y = pd.read_csv('cmbi/pv_ts_sg_stats_sx_3y.csv', index_col=0)
	complete_performance_sx_ytd = pd.read_csv('cmbi/complete_performance_sx_ytd.csv', index_col=0, parse_dates=True)
	complete_performance_sx_3y = pd.read_csv('cmbi/complete_performance_sx_3y.csv', index_col=0, parse_dates=True)
	holdings_sx = pd.read_csv('cmbi/holdings_sx.csv')

	risk_metrics_sd_ytd = pd.read_csv('cmbi/pv_ts_sg_stats_sd_ytd.csv', index_col=0)
	risk_metrics_sd_3y = pd.read_csv('cmbi/pv_ts_sg_stats_sd_3y.csv', index_col=0)
	complete_performance_sd_ytd = pd.read_csv('cmbi/complete_performance_sd_ytd.csv', index_col=0, parse_dates=True)
	complete_performance_sd_3y = pd.read_csv('cmbi/complete_performance_sd_3y.csv', index_col=0, parse_dates=True)
	holdings_sd = pd.read_csv('cmbi/holdings_sd.csv')

	env = Environment(loader=FileSystemLoader('.'))
	template = env.get_template('cmbi/template.html')
	...
	plt.savefig('cmbi/complete_performance_sgm_ytd.png', format='png')
	complete_performance_sgm_3y.plot(color=['#EE2F79', '#00ABC0'])
	plt.savefig('cmbi/complete_performance_sgm_3y.png', format='png')

	complete_performance_sx_ytd.plot(color=['#EE2F79', '#00ABC0'])
	plt.savefig('cmbi/complete_performance_sx_ytd.png', format='png')
	complete_performance_sx_3y.plot(color=['#EE2F79', '#00ABC0'])
	plt.savefig('cmbi/complete_performance_sx_3y.png', format='png')

	complete_performance_sd_ytd.plot(color=['#EE2F79', '#00ABC0'])
	plt.savefig('cmbi/complete_performance_sd_ytd.png', format='png')
	complete_performance_sd_3y.plot(color=['#EE2F79', '#00ABC0'])
	plt.savefig('cmbi/complete_performance_sd_3y.png', format='png')
	...
	url_dir = '/home/aqumon/www/chart.aqumon.com/2B-materials/CMBI/' \
			  + end.replace('-', '') + '/'
