...
if __name__ == '__main__':
	risk_metrics = pd.read_csv('sgm/pv_ts_sg_stats_sgm_ytd.csv', index_col=0)
	risk_metrics_2018 = pd.read_csv('sgm/pv_ts_sg_stats_sgm_3y.csv', index_col=0)
	complete_performance = pd.read_csv('sgm/complete_performance_sgm_ytd.csv', index_col=0, parse_dates=True)
	complete_performance_2018 = pd.read_csv('sgm/complete_performance_sgm_3y.csv', index_col=0, parse_dates=True)
	holdings = pd.read_csv('sgm/holdings.csv')
	# rotation_holdings = pd.read_csv('bochkam/rotation_holdings.csv')
	regional_dis = pd.read_csv('sgm/regional_dis.csv')
	duration = pd.read_csv('sgm/duration.csv')

	env = Environment(loader=FileSystemLoader('.'))
	template = env.get_template('sgm/template.html')
	...
	plt.savefig('sgm/complete_performance.png', format='png')
	complete_performance_2018.plot()
	plt.savefig('sgm/complete_performance_2018.png', format='png')
	...
	url_dir = '/home/aqumon/www/chart.aqumon.com/2B-materials/SGM/' \
			  + end.replace('-', '') + '/'
	upload(
