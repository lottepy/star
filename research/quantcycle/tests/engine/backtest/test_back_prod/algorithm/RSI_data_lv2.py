...
class Allocation_strategy(BaseStrategy):
    ...
    def on_data(self, data_dict: dict, time_dict: dict, ref_data_dict: dict, ref_time_dict: dict):
        ...
        if current_time == 1509494400 + 6*60*60 + 57*60 : # 2017年11月1日WednesdayAM12点00分 First time point
            if len(data_dict) == 6 and len(time_dict) == 6 and len(ref_data_dict) == 0 and len(ref_time_dict) == 0 and \
                ...
                if time_dict['main'][-1,5] == 1 and time_dict['main'][-1,6] == 6 and time_dict['main'][-1,7] == 57 and \
                    time_dict['main'][-2,5] ==31 and time_dict['main'][-2,6] == 6 and time_dict['main'][-2,7] == 57 and \
                    time_dict['RSI_pnl'][-1,5] == 1 and time_dict['RSI_pnl'][-1,6] == 6 and time_dict['RSI_pnl'][-1,7] == 57 and \
                    time_dict['RSI_position'][-1,5] == 1 and time_dict['RSI_position'][-1,6] == 6 and time_dict['RSI_position'][-1,7] == 57:
            ...
            if len(data_dict) == 6 and len(time_dict) == 6 and len(ref_data_dict) == 1 and len(ref_time_dict) == 1 and \
                ...
                if ref_time_dict['signal_remark'][-1,5] == 15 and \
                    ref_time_dict['signal_remark'][-1,6] == 6 and \
                    ref_time_dict['signal_remark'][-1,7] == 57 :
            ...
            if len(data_dict) == 7 and len(time_dict) == 7 and len(ref_data_dict) == 1 and len(ref_time_dict) == 1 and \
                data_dict['main'].shape == (2, 8, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (1, 8, 1) and time_dict['fxrate'].shape == (1, 9) and \
                data_dict['int'].shape == (1, 8, 1) and time_dict['int'].shape == (1, 9) and \
                ...
                if abs(data_dict['RSI_pnl'][-3,16,0] - 2862.97957565) < eps and \
                    ...
                    abs(data_dict['RSI_metrics_61'][-1,-2, 5] - 0.0) < eps:
                    remark['RSI_data_w/o_ref_w_metrics61_correct'] = 1
                else:
                    remark['RSI_data_w/o_ref_w_metrics61_correct'] = 0
                
                if time_dict['RSI_metrics_61'][-1,5] == 31  and \
                    time_dict['RSI_metrics_61'][-1,6] == 6 and \
                    time_dict['RSI_metrics_61'][-1,7] == 57:
            ...
            if len(data_dict) == 7 and len(time_dict) == 7 and len(ref_data_dict) == 3 and len(ref_time_dict) == 3 and \
                ...
                if abs(ref_data_dict['ref_daily'][-2,0,3] - 2.96) < eps and \
                    ...
                    abs(ref_data_dict['ref_hourly'][-2,0,0] - 80.502) < eps and \
                    abs(ref_data_dict['ref_hourly'][-4,2,0] - 1116.065) < eps:
                ...
                if ref_time_dict['ref_daily'][-1,5] == 13 and ref_time_dict['ref_daily'][-1,6] == 8 and \
                    ...
                    ref_time_dict['ref_hourly'][-1,5] == 14 and ref_time_dict['ref_hourly'][-1,6] == 6 and \
                    ref_time_dict['ref_hourly'][-2,5] == 14 and ref_time_dict['ref_hourly'][-2,6] == 5:
            ...
            # reference data: ref_daily / ref_hourly / signal_remark
            if len(data_dict) == 8 and len(time_dict) == 8 and len(ref_data_dict) == 3 and len(ref_time_dict) == 3 and \
                data_dict['main'].shape == (2, 8, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (1, 8, 1) and time_dict['fxrate'].shape == (1, 9) and \
                data_dict['int'].shape == (1, 8, 1) and time_dict['int'].shape == (1, 9) and \
                ...
                if abs(data_dict['RSI_metrics_252'][0, -70, 4] - 0.013259) < eps and \
                    abs(data_dict['RSI_metrics_252'][0, -100, 5] - 2.0) < eps:
                    remark['RSI_data_w_ref_w_metrics252_correct'] = 1
                else:
                    remark['RSI_data_w_ref_w_metrics252_correct'] = 0
                
                if time_dict['RSI_metrics_252'][-1,5] == 30 and \
                    time_dict['RSI_metrics_252'][-1,6] == 6 and \
                    time_dict['RSI_metrics_252'][-1,7] == 57:
