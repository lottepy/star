...
class Allocation_strategy(BaseStrategy):
    ...
    def on_data(self, data_dict: dict, time_dict: dict, ref_data_dict: dict, ref_time_dict: dict):
        ...
        if current_time == 1509494400: # 2017年11月1日WednesdayAM12点00分 First time point
            ...
            # reference data: N/A
            if len(data_dict) == 6 and len(time_dict) == 6 and len(ref_data_dict) == 0 and len(ref_time_dict) == 0:
                remark['input_len_w/o_ref_w/o_signal_remark_correct'] = 1
            else:
                remark['input_len_w/o_ref_w/o_signal_remark_correct'] = 0
            
            if data_dict['main'].shape == (2, 4, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (2, 4, 1) and time_dict['fxrate'].shape == (2, 9) and \
                data_dict['int'].shape == (2, 4, 1) and time_dict['int'].shape == (2, 9) and \
                data_dict['RSI_pnl'].shape == (1, 384, 1) and time_dict['RSI_pnl'].shape == (1, 9) and \
                data_dict['RSI_position'].shape == (1, 384, 1) and time_dict['RSI_position'].shape == (1,9):
                remark['input_array_shape_w/o_ref_w/o_signal_remark_correct'] = 1
            else:
                remark['input_array_shape_w/o_ref_w/o_signal_remark_correct'] = 0
            
            if time_dict['fxrate'][-1, 5] == 1 and time_dict['fxrate'][-1, 6] == 0 and \
                time_dict['int'][-1, 5] == 1 and time_dict['int'][-1, 6] == 0:
                remark["main_data_time_w/o_ref_w/o_signal_remark_correct"] = 1
            else:
                remark["main_data_time_w/o_ref_w/o_signal_remark_correct"] = 0
            
            if abs(data_dict['fxrate'][-1, 1, 0] - 0.008785802) < eps and \
                abs(data_dict['int'][-1, 0, 0] - 4.1989616e-05) < eps:
            ...
            if len(data_dict) == 6 and len(time_dict) == 6 and len(ref_data_dict) == 1 and len(ref_time_dict) == 1:
                remark['input_len_w/o_ref_correct'] = 1
            else:
                remark['input_len_w/o_ref_correct'] = 0
            if data_dict['main'].shape == (2, 4, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (2, 4, 1) and time_dict['fxrate'].shape == (2, 9) and \
                data_dict['int'].shape == (2, 4, 1) and time_dict['int'].shape == (2, 9) and \
                data_dict['RSI_pnl'].shape == (54, 384, 1) and time_dict['RSI_pnl'].shape == (54, 9) and \
                data_dict['RSI_position'].shape == (1, 384, 1) and time_dict['RSI_position'].shape == (1,9) and \
                ref_data_dict['signal_remark'].shape == (1, 96, 8) and ref_time_dict['signal_remark'].shape == (1, 9):
                remark['input_array_shape_w/o_ref_correct'] = 1
            else:
                remark['input_array_shape_w/o_ref_correct'] = 0
            ...
            # reference data: signal_remark
            if len(data_dict) == 7 and len(time_dict) == 7 and len(ref_data_dict) == 1 and len(ref_time_dict) == 1:
                remark['input_len_w/o_ref_w_metrics61_correct'] = 1
            else:
                remark['input_len_w/o_ref_w_metrics61_correct'] = 0
            if data_dict['main'].shape == (2, 4, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (2, 4, 1) and time_dict['fxrate'].shape == (2, 9) and \
                data_dict['int'].shape == (2, 4, 1) and time_dict['int'].shape == (2, 9) and \
                data_dict['RSI_pnl'].shape == (66, 384, 1) and time_dict['RSI_pnl'].shape == (66, 9) and \
                data_dict['RSI_position'].shape == (1, 384, 1) and time_dict['RSI_position'].shape == (1,9) and \
                data_dict['RSI_metrics_61'].shape == (1, 384, 15) and time_dict['RSI_metrics_61'].shape == (1,9) and \
                ref_data_dict['signal_remark'].shape == (1, 96, 8) and ref_time_dict['signal_remark'].shape == (1, 9):
                remark['input_array_shape_w/o_ref_w_metrics61_correct'] = 1
            else:
                remark['input_array_shape_w/o_ref_w_metrics61_correct'] = 0

        elif current_time == 1536883200:    # 2018-09-14 00:00:00
            # data_dict: main/fxrate/int & RSI_pnl/RSI_position/ RSI_metrics_61
            # reference data: ref_daily / ref_hourly / signal_remark
            if len(data_dict) == 7 and len(time_dict) == 7 and len(ref_data_dict) == 3 and len(ref_time_dict) == 3:
                remark['input_len_w_ref_w_metrics61_correct'] = 1
            else:
                remark['input_len_w_ref_w_metrics61_correct'] = 0
            if data_dict['main'].shape == (2, 4, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (2, 4, 1) and time_dict['fxrate'].shape == (2, 9) and \
                data_dict['int'].shape == (2, 4, 1) and time_dict['int'].shape == (2, 9) and \
                data_dict['RSI_pnl'].shape == (228, 384, 1) and time_dict['RSI_pnl'].shape == (228, 9) and \
                data_dict['RSI_position'].shape == (1, 384, 1) and time_dict['RSI_position'].shape == (1,9) and \
                data_dict['RSI_metrics_61'].shape == (1, 384, 15) and time_dict['RSI_metrics_61'].shape == (1,9) and \
                ref_data_dict['signal_remark'].shape == (1, 96, 8) and ref_time_dict['signal_remark'].shape == (1, 9) and \
                ...
                remark['input_array_shape_w_ref_correct'] = 1
            else:
                remark['input_array_shape_w_ref_correct'] = 0
        
        elif current_time == 1537142400:    # 2018年9月17日MondayAM12点00分 a random time point
            # Testing static parameters in the strategy
            assert self.strategy_name == 'Allocation_strategy'
            assert 'main' in self.metadata
            assert self.metadata['main']['symbols'][0] == 'AUDCAD'
            assert self.metadata['main']['symbols'][3] == 'USDJPY'
            assert len(self.metadata['main']['symbol_types']) == 4
            assert self.metadata['main']['symbol_types'][3] == 'FX'
            assert self.metadata['main']['fields'][0] == 'open'
            assert self.metadata['main']['fields'][3] == 'close'
            assert self.metadata['main']['ccy_list'][0] == 'CAD'
            assert self.metadata['main']['ccy_list'][3] == 'JPY'
            assert 'ref_daily' in self.metadata
            assert self.metadata['ref_daily']['symbols'][0] == 'STOCK_1'
            assert self.metadata['ref_daily']['symbols'][4] == 'STOCK_5'
            assert self.metadata['ref_daily']['fields'][0] == 'open'
            assert self.metadata['ref_daily']['fields'][3] == 'close'
            assert 'ref_hourly' in self.metadata
            assert self.metadata['ref_hourly']['symbols'][0] == 'STOCK_2'
            assert self.metadata['ref_hourly']['symbols'][2] == 'STOCK_5'
            assert self.metadata['ref_hourly']['fields'][0] == 'close'
            assert 'remark' in self.metadata
            assert len(self.metadata['remark']['fields']) == 8
            assert '0' in self.metadata
            # assert 0 not in self.metadata
            assert self.metadata['0']['RSI'][0] == 'AUDCAD'
            assert np.nansum(self.ccy_matrix) == 4
            remark['static_parameter_correct'] = 1
            ...
            # reference data: ref_daily / ref_hourly / signal_remark
            if len(data_dict) == 8 and len(time_dict) == 8 and len(ref_data_dict) == 3 and len(ref_time_dict) == 3:
                remark['input_len_w_ref_w_metrics252_correct'] = 1
            else:
                remark['input_len_w_ref_w_metrics252_correct'] = 0
            if data_dict['main'].shape == (2, 4, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (2, 4, 1) and time_dict['fxrate'].shape == (2, 9) and \
                data_dict['int'].shape == (2, 4, 1) and time_dict['int'].shape == (2, 9) and \
                data_dict['RSI_pnl'].shape == (254, 384, 1) and time_dict['RSI_pnl'].shape == (254, 9) and \
                data_dict['RSI_position'].shape == (1, 384, 1) and time_dict['RSI_position'].shape == (1,9) and \
                data_dict['RSI_metrics_61'].shape == (1, 384, 15) and time_dict['RSI_metrics_61'].shape == (1,9) and \
                data_dict['RSI_metrics_252'].shape == (1, 384, 15) and time_dict['RSI_metrics_252'].shape == (1,9) and \
                ref_data_dict['signal_remark'].shape == (1, 96, 8) and ref_time_dict['signal_remark'].shape == (1, 9) and \
                ref_data_dict['ref_daily'].shape == (14, 5, 4) and ref_time_dict['ref_daily'].shape == (14, 9) and \
                ref_data_dict['ref_hourly'].shape == (14, 3, 1) and ref_time_dict['ref_hourly'].shape == (14, 9):
                remark['input_array_shape_w_ref_w_metrics252_correct'] = 1
            else:
                remark['input_array_shape_w_ref_w_metrics252_correct'] = 0
            
            if time_dict['fxrate'][-1, 5] == 30 and time_dict['fxrate'][-1, 6] == 0 and \
                time_dict['int'][-1, 5] == 30 and time_dict['int'][-1, 6] == 0:
                remark["main_data_time_w_ref_w_metrics252_correct"] = 1
            else:
                remark["main_data_time_w_ref_w_metrics252_correct"] = 0
            
            if abs(data_dict['fxrate'][-1, 1, 0] - 0.00881873) < eps and \
                abs(data_dict['int'][-1, 1, 0] - 4.49526734e-05) < eps:
                remark['main_data_w_ref_w_metrics252_correct'] = 1
            else:
                remark['main_data_w_ref_w_metrics252_correct'] = 0
