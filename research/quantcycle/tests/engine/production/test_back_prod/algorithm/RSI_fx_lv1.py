    ...
    def on_data(self, data_dict: dict, time_dict: dict, ref_data_dict: dict, ref_time_dict: dict):
        ...
        if current_time == 1515974400:      # 2018-01-15 00:00:00, reference data empty
            ...
            if self.strategy_name == 'RSI_strategy' and \
                ...
                sum(self.metadata['main']['symbols'] == ['AUDCAD', 'AUDJPY', 'EURUSD', 'USDJPY']) == 4 and \
                len(self.metadata['main']['symbol_types']) == 4 and self.metadata['main']['symbol_types'][3] == 'FX' and \
                self.metadata['main']['fields'] == ['open', 'high', 'low', 'close'] and \
                len(self.metadata['main']['ccy_list'] == ['CAD', 'JPY', 'USD', 'JPY']) == 4 and \
                ...
                sum(sum(self.ccy_matrix) == [1., 1., 1., 1.]) == 4:
