...
class Allocation_strategy(BaseStrategy):
    ...
    def on_data(self, data_dict: dict, time_dict: dict, ref_data_dict: dict, ref_time_dict: dict):
        ...
        if current_time == 1509494400: # 2017年11月1日WednesdayAM12点00分 First time point
            ...
            # reference data: N/A
            if len(data_dict) == 5 and len(time_dict) == 5 and len(ref_data_dict) == 0 and len(ref_time_dict) == 0:
            ...
            if abs(data_dict['fxrate'][-1, 1, 0] - 0.0087858) < eps and \
            ...
            if len(data_dict) == 5 and len(time_dict) == 5 and len(ref_data_dict) == 1 and len(ref_time_dict) == 1:
            ...
            if data_dict['main'].shape == (2, 4, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (2, 4, 1) and time_dict['fxrate'].shape == (2, 9) and \
                data_dict['int'].shape == (2, 4, 1) and time_dict['int'].shape == (2, 9) and \
                data_dict['RSI_pnl'].shape == (54, 24, 1) and time_dict['RSI_pnl'].shape == (54, 9) and \
            ...
            if data_dict['main'].shape == (2, 4, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (2, 4, 1) and time_dict['fxrate'].shape == (2, 9) and \
                data_dict['int'].shape == (2, 4, 1) and time_dict['int'].shape == (2, 9) and \
                data_dict['RSI_pnl'].shape == (66, 24, 1) and time_dict['RSI_pnl'].shape == (66, 9) and \
                data_dict['RSI_position'].shape == (1, 24, 1) and time_dict['RSI_position'].shape == (1,9) and \
            ...
            if len(data_dict) == 6 and len(time_dict) == 6 and len(ref_data_dict) == 3 and len(ref_time_dict) == 3:
            ...
            if data_dict['main'].shape == (2, 4, 4) and time_dict['main'].shape == (2, 9) and \
                data_dict['fxrate'].shape == (2, 4, 1) and time_dict['fxrate'].shape == (2, 9) and \
                data_dict['int'].shape == (2, 4, 1) and time_dict['int'].shape == (2, 9) and \
                data_dict['RSI_pnl'].shape == (228, 24, 1) and time_dict['RSI_pnl'].shape == (228, 9) and \
                data_dict['RSI_position'].shape == (1, 24, 1) and time_dict['RSI_position'].shape == (1,9) and \
                data_dict['RSI_metrics_61'].shape == (1, 24, 15) and time_dict['RSI_metrics_61'].shape == (1,9) and \
            ...
            if self.strategy_name == 'Allocation_strategy' and \
                sum(self.symbol_batch == ['AUDCAD', 'AUDJPY', 'EURUSD', 'USDJPY']) == 4 and \
                len(self.symbol_type) == 4 and \
                self.symbol_type[3] == 'FX' and \
                len(self.secondary_symbol_batch) == 1 and \
                len(self.ref_symbol_batch) == 2 and \
                len(self.ref_symbol_batch['ref_daily']) == 5 and \
                len(self.ref_symbol_batch['ref_hourly']) == 3 and \
                len(self.remark_field_names) == 8 and \
                sum(self.ccy_list == ['CAD', 'JPY', 'USD', 'JPY']) == 4:
                remark['static_parameter_correct'] = 1
            else:
                remark['static_parameter_correct'] = 0
