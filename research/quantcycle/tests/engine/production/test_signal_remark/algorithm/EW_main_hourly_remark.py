...
class EW_strategy(BaseStrategy):
    ...
    def on_data(self, data_dict: dict, time_dict: dict, ref_data_dict: dict, ref_time_dict: dict):
        ...
        # first time point = 1536714000 2018年9月12日WednesdayAM1点00分
        
        # if ref_data_dict['ref_daily'].shape[0]==3: # 1537117200开始 2018年9月16日SundayPM5点00分/17日星期一凌晨1点00分 GMT+08:00
        #     print("ok")
