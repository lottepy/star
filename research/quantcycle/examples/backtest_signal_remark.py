...
def main():
    ...
    run_once('examples/strategy/stocks/config/RSI_stock_lv1_remark.json', rsi_lv1_df)
    run_once('examples/strategy/stocks/config/RSI_stock_lv2_remark.json', rsi_lv2_df)


def generate_rsi_lv1_pool():
    pool_setting = {"symbol": {"STOCKS": ['600016.SH', '000005.SZ', '601398.SH', '600028.SH', '601628.SH',
                                          '002024.SZ', '000100.SZ']},
                    "strategy_module": "examples.strategy.stocks.algorithm.RSI_lv1_remark",
...
def generate_rsi_lv2_pool():
    pool_setting = {"symbol": {"STOCKS": ['600016.SH', '000005.SZ', '601398.SH', '600028.SH',
                    ...
                    "strategy_module": "examples.strategy.stocks.algorithm.RSI_lv2_remark",
