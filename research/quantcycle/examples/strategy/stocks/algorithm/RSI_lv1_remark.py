...
class RSI_strategy(BaseStrategy):
    ...
    def on_data(self, data_dict: dict, time_dict: dict, ref_data_dict: dict, ref_time_dict: dict):
        ...
        current_year, current_month, current_day = time_data[-1, 3], time_data[-1, 4], time_data[-1, 5]
        if current_month == 2 and current_day == 29:
            remark['years_if_feb_29_open'] = current_year
        if current_day == 31:
            remark['months_if_day_31_open'] = current_month
