...
from quantcycle.utils.indicator import RSI
...
class RSI_strategy(BaseStrategy):
    ...
    def on_data(self, data_dict: dict, time_dict: dict, ref_data_dict: dict, ref_time_dict: dict):
        ...
        current_price_level[self.trade_price != 0] = np.divide(close_price[self.trade_price != 0],
                                                               self.trade_price[self.trade_price != 0])
