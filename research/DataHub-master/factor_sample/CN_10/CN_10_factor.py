...
iuid_path = 'CN_10_csv.csv'

#field的csv路径
field_path = 'CN_10_field.csv'
# field_path = 'field_sample.csv'
#初始化Factor_Client类  ass_type为 'fund'或者'stock'
#region可以设置为'HK', 'US' 'CN'
factor_client = Factor_Client(ass_type = 'stock', region = 'CN')
...
data1=factor_client.getdata(iuid_path=iuid_path,field_path=field_path,start_date = '2000-01-01', end_date = '2019-07-31',save_path='/Users/hefan/Desktop/factor_info/CN_10/')
