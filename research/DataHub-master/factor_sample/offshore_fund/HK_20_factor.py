...
class Factor_Client(object):
	def __init__(self, ass_type = 'stock', region = 'HK'):
		...
		self.endpoint = 'https://market.aqumon.com/v2/market/factors/' + self.endpoint
...
iuid_path = 'HK_20_csv_select.csv'

#field的csv路径
field_path = 'HK_20_field.csv'
# field_path = 'field_sample.csv'
#初始化Factor_Client类  ass_type为 'fund'或者'stock'
#region可以设置为'HK', 'US' 'CN'
factor_client = Factor_Client(ass_type = 'fund', region = 'HK')
...
data1=factor_client.getdata(iuid_path=iuid_path,field_path=field_path,start_date = '2000-12-31', end_date = '2019-07-31',save_path='/Users/hefan/Desktop/factor_info/HK_20/')
